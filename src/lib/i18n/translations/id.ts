export const id = {
  ...
  myTasks: "Tugas Saya",
  noActiveTasksAssigned: "Tidak ada tugas aktif",
  managementActions: "Aksi Manajemen",
  pendingReviews: "Tinjauan Tertunda",
  availableTasks: "Tugas Tersedia",
  noPendingReviews: "Tidak ada tinjauan tertunda",
  noAvailableTasks: "Tidak ada tugas tersedia",
  allTasksUpToDate: "Semua tugas sudah diperbarui",
  checkBackLater: "Periksa lagi nanti untuk kesempatan",
  items: "item",
  teamTasks: "Tugas Tim",
